/*
 * 게임에 등장하는 모든 GameObject와 JComponent들을 저장하고 관리한다.
 */
package dodge;
...
public class ObjLib {
    ...
    private ObjLib(){
        ...
        JButton resetBtn      = new JButton("reset records");
        ...
        jcomponentMap.put("resetBtn", resetBtn);
        ...
        JLabel gradeLabel    = new JLabel("1st Place");
        JLabel result        = new JLabel("aaaa");
        jcomponentMap.put("gameOver", gameOverLabel);
        jcomponentMap.put("result", result);
        jcomponentMap.put("gradeLabel", gradeLabel);
        
        JLabel nameLabel   = new JLabel("user name: ");
        JTextField nameBox = new JTextField("noname");
        
        JLabel nameInfo1 = new JLabel("이름을 입력하고 [ENTER]키를 누르면 ");
        JLabel nameInfo2 = new JLabel("입력한 이름으로 점수가 저장됩니다.");
        JLabel nameInfo3 = new JLabel("(이름은 6자 이하의 영어/숫자만 쓰세요)");
        //JLabel nameInfo = new JLabel(" ");
        
        jcomponentMap.put("nameLabel", nameLabel);
        jcomponentMap.put("nameBox", nameBox);
        jcomponentMap.put("nameInfo1", nameInfo1);
        jcomponentMap.put("nameInfo2", nameInfo2);
        jcomponentMap.put("nameInfo3", nameInfo3);
        
        //---------------------SCORES------------------------
        JLabel thankLabel   = new JLabel("Thank You For Playing!");
        JLabel creditLabel  = new JLabel("made by KUR CREATIVE");
        JTextPane scorePane = new JTextPane();
        JTextPane scoreInfo = new JTextPane();
        jcomponentMap.put("thankLabel", thankLabel);
        jcomponentMap.put("scorePane", scorePane);
        jcomponentMap.put("creditLabel", creditLabel);
        jcomponentMap.put("scoreInfo", scoreInfo);
